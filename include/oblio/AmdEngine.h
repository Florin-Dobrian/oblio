...
// and on `QuotientGraphCompacted` over `AMD_2`'s pooled workspace with its free cursor and its
// compaction. They are the same algorithm and MUST return the same permutation, entry for entry,
