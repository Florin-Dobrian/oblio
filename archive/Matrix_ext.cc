// Matrix_exp.cc — explicit instantiation style
//
...
// translation units pick up those symbols at link time via Matrix_exp.o.
...
// Matrix_exp.h. No other files need to change.
