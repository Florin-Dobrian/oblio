...
def eliminate(A, C, cliques, weight, eliminated, pivot):
    ...
    Returns (neighbors, absorbed, pruned, merged). Same as md3; the difference in
...
def minimum_degree(graph):
    ...
    print(f"degree computations: {refreshes}   "
          f"(md3 would do one per live vertex per step)")
    return order


# %%
# The same three graphs as md1, md2 and md3.
#
