...
int main() {
    ...
    DirectSolver<Val> solver(Ordering::MmdFlat, Factorization::Cholesky, Traversal::Multifrontal);
    ...
    solver.analyze(A);
    solver.setOrdering(Ordering::AmdFlat);
    report("setOrdering: MmdFlat -> AmdFlat");
